    ...
    def _initialize_help_content(self) -> Dict[str, HelpContent]:
        ...
        return {
            ...
            "get": HelpContent(
                ...
                usage=["get host <name>", "show details for <name>", "info <name>"],
                examples=["get host server01", "show details for web01", "info db01"],
                related=["hosts", "list"],
            ...
            "stats": HelpContent(
                ...
                usage=["stats", "statistics", "show stats"],
                examples=["stats", "statistics", "show stats"],
            ...
            "test": HelpContent(
                ...
                usage=["test", "test connection", "check connection"],
                examples=["test", "test connection", "check connection"],
                related=["stats"],
                aliases=["check"],
            ),
            "help": HelpContent(
                ...
                examples=["help", "? hosts", "help services", "man create"],
                related=["general"],
                aliases=["?", "h", "man"],
            ),
            "find": HelpContent(
            ...
            "theme": HelpContent(
                ...
                usage=["theme list", "theme set <theme_name>", "theme current"],
                examples=[
                    "theme list",
                    "theme set dark",
            ...
            "colors": HelpContent(
                ...
                usage=["colors show", "colors test", "colors terminal"],
                examples=["colors show", "colors test", "colors terminal"],
                related=["theme"],
                aliases=["color"],
            ),
        }
...
"""
    ...
    def _show_no_help_found(self, topic: str) -> str:
        ...
        suggestions = difflib.get_close_matches(
            topic, all_commands + all_aliases, n=3, cutoff=0.4
        )
    ...
    def get_command_suggestions(self, partial_command: str) -> List[str]:
        ...
        if len(suggestions) < 5:
            ...
            fuzzy_matches = difflib.get_close_matches(
                partial, all_commands + all_aliases, n=5 - len(suggestions), cutoff=0.3
            )
