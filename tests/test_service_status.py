...
class TestServiceStatusManager:
    ...
    def test_get_service_status_details_not_found(self):
        ...
        # Test service details
        details = self.status_manager.get_service_status_details('server01', 'NonExistent')
    ...
    def test_health_message_generation(self):
        ...
        message = self.status_manager._generate_health_message(health_summary, problem_analysis)
