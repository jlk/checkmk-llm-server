...
class TestParameterWorkflowIntegration:
    ...
    def mock_checkmk_client(self):
        ...
        client.get_effective_parameters = AsyncMock(return_value={
            "result": {
        ...
        client.create_rule = AsyncMock(return_value={
            "result": {
                "rule_id": "temp_rule_001",
                "folder": "/servers/production"
            }
        })
        
        client.update_rule = AsyncMock(return_value={
            "result": {
                "rule_id": "temp_rule_001",
                "updated": True
            }
        ...
        client.delete_rule = AsyncMock(return_value={
            "result": {"deleted": True}
        })
        
        client.list_rulesets = AsyncMock(return_value={
            "result": [
        ...
        client.get_ruleset_info = AsyncMock(return_value={
            "result": {
    ...
    async def test_complete_temperature_workflow(self, parameter_service):
        ...
        defaults_result = await parameter_service.get_specialized_defaults("CPU Temperature")
    ...
    async def test_database_parameter_workflow(self, parameter_service):
        ...
        mysql_defaults = await parameter_service.get_specialized_defaults("MySQL Connections")
        ...
        suggestions = suggestions_result.data  # data is directly the list of suggestions
    ...
    async def test_network_service_workflow(self, parameter_service):
        ...
        https_defaults = await parameter_service.get_specialized_defaults("HTTPS API Health")
    ...
    async def test_custom_check_workflow(self, parameter_service):
        ...
        mrpe_defaults = await parameter_service.get_specialized_defaults("MRPE check_disk")
    ...
    async def test_bulk_parameter_operations(self, parameter_service):
        ...
        expected_handlers = [
            ...
            "database", "database", "network_services"
        ]
    ...
    async def test_error_handling_and_recovery(self, parameter_service):
        ...
        unknown_result = await parameter_service.get_specialized_defaults("Unknown Service Type")
        ...
        with patch.object(parameter_service.checkmk, 'create_rule', side_effect=Exception("API Error")):
            set_result = await parameter_service.set_service_parameters(
                "server01",  # host_name
                "CPU Temperature",  # service_name
...
class TestMCPToolIntegration:
    ...
    def mock_checkmk_client(self):
        ...
        client.get_effective_parameters = AsyncMock(return_value={
            "result": {"parameters": {"levels": (80.0, 90.0)}}
        })
        client.create_rule = AsyncMock(return_value={"result": {"rule_id": "test_rule"}})
        client.list_rulesets = AsyncMock(return_value={"result": ["checkgroup_parameters:temperature"]})
        client.get_ruleset_info = AsyncMock(return_value={
            "result": {"name": "checkgroup_parameters:temperature", "title": "Temperature"}
        })
    ...
    async def test_mcp_error_handling(self, mcp_server):
        ...
        result = await mcp_server.call_tool("get_specialized_defaults", invalid_arguments)
        ...
        try:
            ...
            assert "unexpected keyword argument" in result_text or "error" in result_text.lower()
    ...
    async def test_mcp_tool_comprehensive_workflow(self, mcp_server):
        ...
        discover_result = await mcp_server.call_tool("discover_parameter_handlers", discover_args)
        ...
        defaults_result = await mcp_server.call_tool("get_specialized_defaults", defaults_args)
        ...
        validate_result = await mcp_server.call_tool("validate_specialized_parameters", validate_args)
        ...
        suggest_result = await mcp_server.call_tool("get_parameter_suggestions", suggest_args)
...
class TestConcurrentOperations:
    ...
    def parameter_service(self):
        ...
        client = Mock()
        client.get_effective_parameters = AsyncMock(return_value={"result": {"parameters": {}}})
    ...
    async def test_concurrent_default_generation(self, parameter_service):
        ...
        service_names = [
            "CPU Temperature", "GPU Temperature", "System Temperature",
            "MySQL Connections", "Oracle Tablespace", "PostgreSQL Locks",
            "HTTP Health Check", "HTTPS API", "TCP Port Check",
            "MRPE check_disk", "Local check_memory", "Custom Script"
