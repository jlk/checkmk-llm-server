...
class TestCheckmkAPIIntegration:
    ...
    def test_get_host_integration(self, checkmk_client):
        ...
        with requests_mock.Mocker() as m:
            ...
            assert host["extensions"]["effective_attributes"]["inherited_setting"] == "folder_value"
    ...
    def test_bulk_operations_integration(self, checkmk_client):
        ...
        with requests_mock.Mocker() as m:
            ...
            hosts_to_create = [
                ...
                {"folder": "/test", "host_name": "bulk-host-2", "attributes": {"ipaddress": "192.168.1.50"}}
            ]
            ...
            assert request_data["entries"][1]["attributes"]["ipaddress"] == "192.168.1.50"
...
class TestLLMIntegration:
    ...
    def test_command_parsing_integration(self, mock_openai, llm_config):
        ...
        with patch('checkmk_agent.llm_client.OPENAI_AVAILABLE', True):
            ...
            result = llm_client.parse_command("create web server web-server-03 in /web folder with IP 192.168.1.30")
    ...
    def test_response_formatting_integration(self, mock_openai, llm_config):
        ...
        with patch('checkmk_agent.llm_client.OPENAI_AVAILABLE', True):
            ...
            result = llm_client.format_response(HostOperation.LIST, hosts_data, success=True)
