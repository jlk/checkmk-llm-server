...
class TestServiceParameterManager:
    ...
    def test_validate_parameters_valid_levels(self, service_parameter_manager):
        ...
        result = service_parameter_manager.validate_parameters('cpu_utilization_linux', parameters)
    ...
    def test_validate_parameters_invalid_levels_order(self, service_parameter_manager):
        ...
        parameters = {
            'levels': (90.0, 80.0),  # Warning > Critical
            'average': 15
        }
        result = service_parameter_manager.validate_parameters('cpu_utilization_linux', parameters)
    ...
    def test_validate_parameters_filesystem_valid(self, service_parameter_manager):
        ...
        result = service_parameter_manager.validate_parameters('filesystems', parameters)
        assert result is True
    
    def test_validate_parameters_filesystem_invalid_magic(self, service_parameter_manager):
    ...
    def test_create_parameter_rule(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_create_simple_override(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_get_service_parameters_no_rules(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_get_service_parameters_with_rules(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_delete_parameter_rule(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_list_parameter_rulesets(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_list_parameter_rulesets_filtered(self, service_parameter_manager, mock_checkmk_client):
...
class TestServiceParameterManagerError:
    ...
    def test_create_rule_api_error(self, service_parameter_manager, mock_checkmk_client):
    ...
    def test_get_service_parameters_api_error(self, service_parameter_manager, mock_checkmk_client):
        """Test handling API errors when getting service parameters."""
        mock_checkmk_client.search_rules_by_host_service.side_effect = CheckmkAPIError("API Error")
    ...
    def test_list_rulesets_api_error(self, service_parameter_manager, mock_checkmk_client):
...
class TestServiceParameterManagerIntegration:
    ...
    def test_full_override_workflow(self, service_parameter_manager, mock_checkmk_client):
