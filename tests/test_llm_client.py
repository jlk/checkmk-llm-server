...
from checkmk_agent.llm_client import (
    LLMClient, OpenAIClient, AnthropicClient, ParsedCommand, 
    HostOperation, LLMProvider, create_llm_client
)
from checkmk_agent.config import LLMConfig
...
class TestParsedCommand:
    ...
    def test_default_values(self):
        ...
        cmd = ParsedCommand(
            operation=HostOperation.CREATE,
            parameters={"host_name": "test"}
        )
...
class TestOpenAIClient:
    ...
    def test_initialization_missing_library(self, llm_config):
        ...
        with patch('checkmk_agent.llm_client.OPENAI_AVAILABLE', False):
    ...
    def test_format_response_list_success(self, mock_openai, llm_config):
        ...
        with patch('checkmk_agent.llm_client.OPENAI_AVAILABLE', True):
            ...
            result = client.format_response(HostOperation.LIST, hosts_data, success=True)
    ...
    def test_format_response_create_success(self, mock_openai, llm_config):
        ...
        with patch('checkmk_agent.llm_client.OPENAI_AVAILABLE', True):
            ...
            result = client.format_response(HostOperation.CREATE, create_data, success=True)
...
class TestAnthropicClient:
    ...
    def test_initialization_missing_library(self, llm_config):
        ...
        with patch('checkmk_agent.llm_client.ANTHROPIC_AVAILABLE', False):
...
class TestCreateLLMClient:
    ...
    def test_create_openai_client_explicit(self, llm_config):
        ...
        with patch('checkmk_agent.llm_client.OPENAI_AVAILABLE', True):
            with patch('checkmk_agent.llm_client.openai.OpenAI'):
    ...
    def test_create_anthropic_client_explicit(self, llm_config):
        ...
        with patch('checkmk_agent.llm_client.ANTHROPIC_AVAILABLE', True):
            with patch('checkmk_agent.llm_client.anthropic.Anthropic'):
