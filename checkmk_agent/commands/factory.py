...
class CommandFactory:
    ...
    def __init__(self, 
        ...
        self.config = config
        self.parameter_manager = parameter_manager or ServiceParameterManager(checkmk_client, config)
    ...
    def register_command_class(self, name: str, command_class: Type[BaseCommand]) -> 'CommandFactory':
        ...
        self.logger.debug(f"Registered command class '{name}': {command_class.__name__}")
        return self
    ...
    def get_factory_info(self) -> Dict[str, Any]:
        ...
        """
        return {
            'checkmk_client': self.checkmk_client.__class__.__name__ if self.checkmk_client else None,
            'parameter_manager': self.parameter_manager.__class__.__name__ if self.parameter_manager else None,
